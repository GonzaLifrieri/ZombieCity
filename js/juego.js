...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 530, 410, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 160, 460, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 445, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 475, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 170, 100, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 140, 100, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 170, 210, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 300, 480, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 450, 125, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 810, 430, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 400, 480, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 75, 270, 15, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',420,420,10,10,1.5,{desdeX: 400, hastaX: 480, desdeY: 400, hastaY: 420}),
    new ZombieCaminante('imagenes/zombie2.png',790,200,10,10,1,{desdeX: 790, hastaX: 860, desdeY: 180, hastaY: 200}),
    new ZombieCaminante('imagenes/zombie3.png',230,450,10,10,1.5,{desdeX: 230, hastaX: 310, desdeY: 430, hastaY: 450}),
    new ZombieCaminante('imagenes/zombie4.png',450,240,10,10,1,{desdeX: 450, hastaX: 530, desdeY: 220, hastaY: 240}),
    new ZombieCaminante('imagenes/zombie1.png',320,130,10,10,1.5,{desdeX: 320, hastaX: 400, desdeY: 110, hastaY: 130}),
    new ZombieConductor('imagenes/tren_horizontal.png',400,322,90,30,5,{desdeX: 20, hastaX: 931, desdeY: 322, hastaY:322 },"horizontal"),
    new ZombieConductor('imagenes/tren_vertical.png',644,507,30,90,5,{desdeX: 644, hastaX: 644, desdeY: 0, hastaY: 507},"vertical"),
    new ZombieConductor('imagenes/tren_vertical.png',678,0,30,90,5,{desdeX: 678, hastaX: 678, desdeY: 0, hastaY: 507},"vertical")
  ]
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('red', 759, 514, 128, 50)
};
